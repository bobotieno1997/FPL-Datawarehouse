...
SELECT -- Generates a unique surrogate key for each history record using ROW_NUMBER()
...
FROM silver.players_info spi -- Alias 'spi' for clarity and brevity
